            ...
            <table style="width:90%;height:100%;padding-top:10px" cellspacing="5">
                <tr height="30px">
	                ...
	                <td align="left" style="width:30%">
	                   <select name="vehicleClass" id="vehicleClass" class="easyui-combobox" editable="false" data-options="required:true,disabled:true">
	                        ...
	                        <option value="摩托车" selected="true">摩托车</option>
	                    </select>
	                </td>  
	            </tr> 
               <tr height="30px">
               ...
               <tr height="30px">
	                <td align="right" style="width:15%">排量:</td>
	                <td align="left" style="width:25%">
	               ...
	               <td align="right" style="width:15%">车辆来源:</td>
	                <td align="left" style="width:25%">
	                   <select name="vehicleType" id="vehicleType" class="easyui-combobox" width="317px" editable="false" data-options="required:true,disabled:true">
	                        ...
	                        <option value="2" selected="true">新注册摩托车</option>
	                    </select>
	                </td>
