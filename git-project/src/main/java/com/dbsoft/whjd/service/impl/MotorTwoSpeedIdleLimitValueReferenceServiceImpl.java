...
@Service(value = "motorTwoSpeedIdleLimitValueReferenceService")
public class MotorTwoSpeedIdleLimitValueReferenceServiceImpl implements ILimitValueReferenceService{
