...
@Action(value = "twoSpeedIdleLimitValueReferenceAction", results = { @Result(name = "editLimit", location = "/jsp/limitValueReference/editTwoSpeedIdleLimitValue.jsp") })
public class TwoSpeedIdleLimitValueReferenceAction extends BaseAction implements ModelDriven<LimitValueReferencePage>{
	...
	@Resource(name = "twoSpeedIdleLimitValueReferenceService")
